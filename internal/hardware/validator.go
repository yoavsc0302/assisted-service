...
const (
	...
	diskIsMultipathMember                   = "Disk is a member of a multipath device and is not eligible for installation"
...
func hasMultipathHolder(disk *models.Disk, inventory *models.Inventory) error {
	...
	for _, holder := range holders {
		if _, exists := multipathDiskNamesMap[strings.TrimSpace(holder)]; exists {
			return errors.New(diskIsMultipathMember)
		}
	}
	return nil
}
